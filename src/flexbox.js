		...
		return (
			<View style={[BoxStyles.margginBox]}  ref="lab1">
				...
				<View  style={[BoxStyles.label]}>
				    <Text style={BoxStyles.white}>element</Text>
				</View>
				...
				<View style={[BoxStyles.measureBox]} >
					<View style={[BoxStyles.right]}>
					    <Text style={[BoxStyles.yellow]}>height</Text>
					</View>
				</View>
					<View style={[BoxStyles.bottom,BoxStyles.height50]}>
					    <Text style={BoxStyles.yellow}>width</Text>
					</View>
				</View>
				...
				<View style={[BoxStyles.label]}>
				    <Text style={BoxStyles.white}>padding</Text>
				</View>
				</View>
				...
				<View style={[BoxStyles.bottom,BoxStyles.height50,BoxStyles.bggreen]}>
					...
					<View style={[BoxStyles.label]}>
					    <Text style={BoxStyles.white}>border</Text>
					</View>
				</View>
